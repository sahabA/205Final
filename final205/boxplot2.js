function explodingBoxplot() {
            ...
            update = function(resize) {
               ...
               function draw_jitter(s) {
                  s.attr('r', options.datapoints.radius)
                   .attr('fill',function(d){
					   //console.log(options.data.color_index);
                     return colorScale( d[options.data.color_index])
                  })
                   .attr('cx', function(d) {
               ...
               function explode_boxplot(i) {
				...
				var colorG = d3.scale.ordinal()
                  ...
                  explode_normal
					 ...
					 .style("stroke", function(d) { return colorG(d.Gender)})
                     .call(init_jitter)
                     .transition()
    ...
    chart.data = function(value) {
		...
		//value.sort(function(x, y) { console.log(x); console.log(y); }
		//x['Set Score'].split('-').join('')-y['Set Score'].split('-').join('') 
        value.sort(function(x, y) {return x['BasePay'];});
   ...
   var compute_boxplot = function(data, iqr_scaling_factor, value) {
	   ...
	   /**console.log("value");
		...
		console.log(data);
		console.log("iq");
		console.log(iqr_scaling_factor);**/
